...
// node_modules/.deno/typestyle@2.4.0/node_modules/typestyle/lib.es2015/types.js
var require_types = __commonJS({
  "node_modules/.deno/typestyle@2.4.0/node_modules/typestyle/lib.es2015/types.js"() {
  }
});

// node_modules/.deno/free-style@3.1.0/node_modules/free-style/dist.es2015/index.js
var uniqueId = 0;
var CSS_NUMBER = /* @__PURE__ */ Object.create(null);
var CSS_NUMBER_KEYS = [
...
var Cache = class _Cache {
  ...
  add(style2) {
    ...
    } else if (item instanceof _Cache && style2 instanceof _Cache) {
...
var Style = class _Style extends Cache {
  ...
  clone() {
    return new _Style(this.style, this.id).merge(this);
  }
};
var Rule = class _Rule extends Cache {
  ...
  clone() {
    return new _Rule(this.rule, this.style, this.id).merge(this);
  }
};
...
var FreeStyle = class _FreeStyle extends Cache {
  ...
  clone() {
    return new _FreeStyle(this.id, this.changes).merge(this);
  }
};
...
// node_modules/.deno/typestyle@2.4.0/node_modules/typestyle/lib.es2015/internal/formatting.js
...
// node_modules/.deno/typestyle@2.4.0/node_modules/typestyle/lib.es2015/internal/utilities.js
...
// node_modules/.deno/typestyle@2.4.0/node_modules/typestyle/lib.es2015/internal/typestyle.js
  ...
  function() {
    function TypeStyle2(_a) {
      ...
      this.fontFace = function() {
        var fontFace2 = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          fontFace2[_i] = arguments[_i];
        }
        var freeStyle2 = _this._freeStyle;
        for (var _a2 = 0, _b = fontFace2; _a2 < _b.length; _a2++) {
          var face = _b[_a2];
      ...
      this.keyframes = function(frames) {
        var keyframes2 = convertToKeyframes(frames);
        var animationName = _this._freeStyle.registerKeyframes(keyframes2);
        _this._styleUpdated();
...
// node_modules/.deno/typestyle@2.4.0/node_modules/typestyle/lib.es2015/index.js
...
//# sourceMappingURL=typestyle.js.map
